...
include'sidebar.php';
 ...
 <div class="main">
   <b><i class="fa fa-folder-open"></i> Data Sirkulasi</b><a href="pinjam_print.php" target="blank" rel="tooltip" title="Print Data Peminjaman"><button type="button" name="button" class="btn btn-success" style="margin-left:67%" ><i class="fa fa-fw fa-print"></i></button>
<hr></a>
