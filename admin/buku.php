...
include'sidebar.php';
 ...
 <div class="main">
   <b><i class="fa fa-Book"></i>Identitas Buku</b><a href="#" rel="tooltip" title="Tambah Data Buku"><button type="button" name="button" class="btn btn-secondary" style="margin-left:73%" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><i class="fa fa-fw fa-plus"></i></button>
