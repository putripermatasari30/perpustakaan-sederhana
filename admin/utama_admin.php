...
<div class="main" >
  <h1><i class="fa fa-Home"></i>Database</h1>
 <br>
 <div class="row">
    <div class="col-lg-3 col-6">
        <div class="card bg-primary text-red">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-9 text-sm-right">
                        ...
                        <div class="text-sm">Kelompok Data</div>
                    </div>
                </div>
            </div>
            <a href="anggota.php">
    ...
    <div class="col-lg-3 col-6">
        <div class="card bg-success text-red">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-3">
    ...
    <div class="col-lg-3 col-6">
        <div class="card bg-danger text-red">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-3">
